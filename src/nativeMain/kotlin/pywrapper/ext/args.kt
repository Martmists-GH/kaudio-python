...
fun PyObjectT.parse(name: String, n: Int) : List<PyObjectT> {
    ...
    return memScoped {
        ...
        if (n == 1 && PyArg_ParseTuple(this@parse, "O:$name", args[0].ptr) == 0) {
            ...
            return@memScoped emptyList()
        } else if (n == 4 && PyArg_ParseTuple(this@parse, "OOOO:$name", args[0].ptr, args[1].ptr, args[2].ptr, args[3].ptr) == 0) {
            return@memScoped emptyList()
        } else if (n == 5 && PyArg_ParseTuple(this@parse, "OOOOO:$name", args[0].ptr, args[1].ptr, args[2].ptr, args[3].ptr, args[4].ptr) == 0) {
            return@memScoped emptyList()
        }
...
fun PyObjectT.parseKw(name: String, kw: PyObjectT, vararg args: String) : Map<String, PyObjectT> {
    ...
    return memScoped {
        ...
        if (args.size == 1 && PyArg_ParseTupleAndKeywords(this@parseKw, kw, "O:$name", names, pyArgs[args[0]]!!.ptr) == 0) {
            return@memScoped emptyMap()
        } else if (args.size == 2 && PyArg_ParseTupleAndKeywords(this@parseKw, kw, "OO:$name", names, pyArgs[args[0]]!!.ptr, pyArgs[args[1]]!!.ptr) == 0) {
            return@memScoped emptyMap()
        } else if (args.size == 3 && PyArg_ParseTupleAndKeywords(this@parseKw, kw, "OOO:$name", names, pyArgs[args[0]]!!.ptr, pyArgs[args[1]]!!.ptr, pyArgs[args[2]]!!.ptr) == 0) {
            return@memScoped emptyMap()
        } else if (args.size == 4 && PyArg_ParseTupleAndKeywords(this@parseKw, kw, "OOOO:$name", names, pyArgs[args[0]]!!.ptr, pyArgs[args[1]]!!.ptr, pyArgs[args[2]]!!.ptr, pyArgs[args[3]]!!.ptr) == 0) {
            return@memScoped emptyMap()
        } else if (args.size == 5 && PyArg_ParseTupleAndKeywords(this@parseKw, kw, "OOOOO:$name", names, pyArgs[args[0]]!!.ptr, pyArgs[args[1]]!!.ptr, pyArgs[args[2]]!!.ptr, pyArgs[args[3]]!!.ptr, pyArgs[args[4]]!!.ptr) == 0) {
            return@memScoped emptyMap()
        }
